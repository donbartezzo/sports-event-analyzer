...
export function ProfileForm({ initialUser }: Props) {
  ...
  const onSubmit = async (data: ProfileFormData) => {
    try {
      ...
      const { error } = await supabase.from("profiles").upsert<Database["public"]["Tables"]["profiles"]["Insert"]>({
        id: initialUser.id,
        ...
        <div className="grid gap-2">
          ...
          <Select
            ...
            onValueChange={(value: string) =>
              setValue("preferredAnalysisType", value as "basic" | "advanced" | "expert")
            }
          >
            <SelectTrigger>
          ...
          <div className="grid gap-2">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                disabled={isLoading}
                onCheckedChange={(checked: boolean) => setValue("notifications.email", checked)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                disabled={isLoading}
                onCheckedChange={(checked: boolean) => setValue("notifications.push", checked)}
              />
